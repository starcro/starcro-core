...
function generatePM2NodesConfig(testNodeConfigs) {
	...
	function insertNewNode(index, nodeConfig) {
		...
		var nodePM2Config = {
			...
			error_file: `./test/integration/logs/starcro-test-node-${index}.err.log`,
			out_file: `./test/integration/logs/starcro-test-node-${index}.out.log`,
		};
