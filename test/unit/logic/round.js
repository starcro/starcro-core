		...
		describe('with only one delegate', () => {
			describe('when there are no remaining fees', () => {
				...
				before(done => {
					...
					validScope.roundFees = slots.delegates; // 1 XSC fee per delegate, no remaining fees
					done();
				});
			...
			describe('when there are remaining fees', () => {
				...
				before(done => {
					validScope.roundDelegates = [genesisBlock.generatorPublicKey];
					validScope.roundFees = 100; // 0 XSC fee per delegate, 100 remaining fees
					done();
				});
		...
		describe('with 3 delegates', () => {
			...
			describe('when there are remaining fees', () => {
				...
				before(done => {
					...
					validScope.roundRewards = [1, 2, 3];
					validScope.roundFees = 1000; // 9 XSC fee per delegate, 91 remaining fees
					done();
				});
