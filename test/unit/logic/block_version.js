...
describe('block_version', () => {
	describe('isValid', () => {
		describe('when no exceptions present', () => {
			...
			it('should return true for version = 1, height = 975', () => {
				const height = 975;
				const version = 1;
			...
			it('should return false for version = 0, height = 975', () => {
				const height = 975;
				const version = 0;
			...
			it('should return false for version = 3, height = 975', () => {
				const height = 975;
				const version = 3;
		...
		describe('when 1 exception present', () => {
			...
			it('should return true for version = 0, height = 975', () => {
				const height = 975;
				const version = 0;
			...
			it('should return false for version = 1, height = 975', () => {
				const height = 975;
				const version = 1;
			...
			it('should return false for version = 2, height = 975', () => {
				const height = 975;
				const version = 2;
