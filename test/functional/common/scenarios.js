...
function Multisig(options) {
	...
	this.multiSigTransaction = starcro.transaction.registerMultisignature({
		passphrase: this.account.passphrase,
		keysgroup: this.keysgroup,
		lifetime: this.lifetime,
		minimum: this.minimum,
	});
	this.creditTransaction = starcro.transaction.transfer({
		amount: this.amount,
		passphrase: accountFixtures.genesis.passphrase,
		recipientId: this.account.address,
	});
	this.secondSignatureTransaction = starcro.transaction.registerSecondPassphrase({
		passphrase: this.account.passphrase,
