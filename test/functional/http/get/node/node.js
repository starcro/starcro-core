...
describe('GET /node', () => {
	describe('/constants', () => {
		...
		it('should return a result containing nethash = "3efb0113f226b6860f4be928ceb676624e9ea59a1654cde452712436850d2dcb"', () => {
			return expect(constantsResponse.nethash).to.be.equal(
				'3efb0113f226b6860f4be928ceb676624e9ea59a1654cde452712436850d2dcb'
			);
		});
