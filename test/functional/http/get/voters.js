...
describe('GET /api/voters', () => {
	...
	describe('?', () => {
		...
		describe('sort', () => {
			...
			before(() => {
				var enrichExtraDelegateVoterTransaction = starcro.transaction.transfer({
					amount:
				...
				var registerExtraVoterAsADelegateTransaction = starcro.transaction.registerDelegate(
					{
				...
				var voteByExtraDelegateVoterTransaction = starcro.transaction.castVotes({
					passphrase: validExtraDelegateVoter.passphrase,
