...
describe('GET /delegates', () => {
	...
	describe('/', () => {
		...
		it('using no params but with higher limit should return at least 975 genesis delegates', () => {
			var data = [];

			return delegatesEndpoint
				.makeRequest({ limit: 975 }, 200)
				.then(res => {
					data = res.body.data;
