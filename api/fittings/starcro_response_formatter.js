...
var debug = require('debug')('swagger:starcro:response_formatter');
 ...
 * @returns {function} {@link api.fittings.starcro_response_formatter}
...
module.exports = function create() {
	 ...
	 * Description of the function.
	 *
	 * @func starcro_response_formatter
	 * @memberof api.fittings
	 * @param {Object} context
	 * @param {function} next
	 * @todo Add description for the function and the params
	 */
	return function starcro_response_formatter(context, next) {
		debug('exec');
