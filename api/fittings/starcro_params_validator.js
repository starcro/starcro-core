...
var debug = require('debug')('swagger:starcro:params_validator');
 ...
 * @returns {function} {@link api.fittings.starcro_params_validator}
...
module.exports = function create() {
	 ...
	 * Description of the function.
	 *
	 * @func starcro_params_validator
	 * @memberof api.fittings
	 * @param {Object} context
	 * @param {function} cb
	 * @todo Add description for the function and the params
	 */
	return function starcro_params_validator(context, cb) {
		var error = null;
