...
var debug = require('debug')('swagger:starcro:request_limit');
 ...
 * @returns {function} {@link api.fittings.starcro_request_limit}
...
module.exports = function create(fittingDef) {
	 ...
	 * @todo Add description for the function and the params
	 */
	function starcro_request_limit(context, cb) {
		debug('exec');
		middleware(context.request, context.response, cb);
	}

	starcro_request_limit.limits = limits;
	starcro_request_limit.defaults = defaults;

	return starcro_request_limit;
};
