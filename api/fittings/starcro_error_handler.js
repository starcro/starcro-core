...
var debug = require('debug')('swagger:starcro:error_handler');
 ...
 * @returns {function} {@link api.fittings.starcro_error_handler}
...
module.exports = function create(fittingDef) {
	 ...
	 * Description of the function.
	 *
	 * @func starcro_error_handler
	 * @memberof api.fittings
	 * @param {Object} context
	 * @param {function} cb
	 * @todo Add description for the function and the params
	 */
	return function starcro_error_handler(context, next) {
