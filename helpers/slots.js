...
/**
 * Gets constant time from Starcro epoch.
 *
 * @private
 * @returns {number} Starcro epoch time
 */
...
/**
 * Calculates time since Starcro epoch.
 *
 * @private
 * @param {number|undefined} time - Time in unix seconds
 * @returns {number} Current time - Starcro epoch time
 */
...
module.exports = {
	 ...
	 * @returns {number} Constant time from Starcro epoch + input time
	 * @todo Add description for the function and the params
	 */
